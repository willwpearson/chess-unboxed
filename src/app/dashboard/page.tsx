      ...
      <main className="flex-1 min-h-screen bg-background">
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-12">
              <div className="text-center mb-8">
                <h2 className="text-2xl md:text-3xl font-gaming font-bold text-foreground mb-3">
                  Choose Your Game Mode
                </h2>
                <p className="text-primary-300">
                  Experience revolutionary chess where pieces wrap around board edges
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                <Link href="/play/unboxed/bot" className="gaming-card gaming-glow p-8 text-center hover:scale-105 transition-all duration-300 bg-gradient-to-br from-blue-500/20 to-cyan-600/20 relative overflow-hidden group">
                  ...
                  <h3 className="text-xl font-gaming font-bold text-foreground mb-3">Play vs Bot</h3>
                  <p className="text-primary-300 mb-4">Practice against AI opponents with adjustable difficulty levels</p>
                ...
                <Link href="/play/unboxed/multiplayer" className="gaming-card gaming-glow p-8 text-center hover:scale-105 transition-all duration-300 bg-gradient-to-br from-green-500/20 to-emerald-600/20 relative overflow-hidden group">
                  ...
                  <h3 className="text-xl font-gaming font-bold text-foreground mb-3">Multiplayer</h3>
                  <p className="text-primary-300 mb-4">Challenge other players in real-time competitive matches</p>
                  <div className="text-sm text-primary-300 space-y-1">
                ...
                <Link href="/play/unboxed/endless" className="gaming-card gaming-glow p-8 text-center hover:scale-105 transition-all duration-300 bg-gradient-to-br from-purple-500/20 to-pink-600/20 relative overflow-hidden group">
                  ...
                  <h3 className="text-xl font-gaming font-bold text-foreground mb-3">Endless Mode</h3>
                  <p className="text-primary-300 mb-4">Ultimate challenge - progressive difficulty, one loss ends it all</p>
                  <div className="text-sm text-primary-300 space-y-1">
            ...
            {/* Quick Actions */}
            <div className="mb-8">
              <h2 className="text-2xl font-gaming font-bold text-foreground mb-6">Quick Actions</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <Link href="/lobby" className="gaming-card gaming-glow p-6 text-center hover:scale-105 transition-transform duration-300">
                  ...
                  <h3 className="font-bold text-foreground mb-2">Join Lobby</h3>
                  <p className="text-sm text-primary-300">Find opponents to play against</p>
                </Link>
                ...
                <Link href="/leaderboard" className="gaming-card gaming-glow p-6 text-center hover:scale-105 transition-transform duration-300">
                  <Trophy size={40} className="mx-auto mb-3 text-secondary" />
                  <h3 className="font-bold text-foreground mb-2">Leaderboard</h3>
                  <p className="text-sm text-primary-300">See your ranking</p>
                </Link>

                <Link href="/stats" className="gaming-card gaming-glow p-6 text-center hover:scale-105 transition-transform duration-300">
                  <TrendingUp size={40} className="mx-auto mb-3 text-secondary" />
                  <h3 className="font-bold text-foreground mb-2">Detailed Stats</h3>
                  <p className="text-sm text-primary-300">View full analytics</p>
                </Link>

                <Link href="/settings" className="gaming-card gaming-glow p-6 text-center hover:scale-105 transition-transform duration-300">
                  <Target size={40} className="mx-auto mb-3 text-secondary" />
                  <h3 className="font-bold text-foreground mb-2">Settings</h3>
                  <p className="text-sm text-primary-300">Customize your experience</p>
                </Link>
              </div>
            </div>
            ...
            {/* Profile Information */}
            <div className="mb-8">
              <h2 className="text-2xl font-gaming font-bold text-foreground mb-6">Your Profile</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="gaming-card gaming-glow p-6 text-center">
                  <Trophy size={32} className="mx-auto mb-3 text-secondary" />
                  <h3 className="text-2xl font-bold text-foreground mb-1">{user.current_rating}</h3>
                  <p className="text-primary-300">Current Rating</p>
                  <p className="text-sm text-primary-300 mt-1">Peak: {user.peak_rating}</p>
                </div>

                <div className="gaming-card gaming-glow p-6 text-center">
                  <Gamepad2 size={32} className="mx-auto mb-3 text-secondary" />
                  <h3 className="text-2xl font-bold text-foreground mb-1">{user.total_games}</h3>
                  <p className="text-primary-300">Games Played</p>
                </div>

                <div className="gaming-card gaming-glow p-6 text-center">
                  <TrendingUp size={32} className="mx-auto mb-3 text-secondary" />
                  <h3 className="text-2xl font-bold text-foreground mb-1">{winRate}%</h3>
                  <p className="text-primary-300">Win Rate</p>
                  <p className="text-sm text-primary-300 mt-1">{user.wins}W {user.losses}L {user.draws}D</p>
                </div>

                <div className="gaming-card gaming-glow p-6 text-center">
                  <Target size={32} className="mx-auto mb-3 text-secondary" />
                  <h3 className="text-2xl font-bold text-foreground mb-1">{user.wins}</h3>
                  <p className="text-primary-300">Total Wins</p>
                </div>
              </div>
            </div>
            ...
            {/* Recent Activity */}
            <div>
              <h2 className="text-2xl font-gaming font-bold text-foreground mb-6">Recent Activity</h2>
