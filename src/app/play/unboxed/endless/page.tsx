...
import { ArrowLeft, Infinity, Trophy, Target, AlertTriangle, Zap } from 'lucide-react';
...
export default function UnboxedEndlessGamePage() {
  ...
  const handleStartEndless = async () => {
    ...
    try {
      ...
      const newGame: GameState = {
        gameId: `endless-unboxed-${Date.now()}`,
        mode: 'endless',
        variant: 'unboxed',
        status: 'active',
        result: 'ongoing',
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8">
                ...
                <div className="gaming-card p-8 text-center bg-gradient-to-br from-purple-500/20 to-pink-600/20">
                  ...
                  <h2 className="text-3xl font-gaming font-bold gaming-title mb-4">Chess Unboxed - Endless Mode</h2>
                  <p className="text-gaming-text-secondary text-lg">
                    Face increasingly difficult opponents with toroidal board mechanics. One loss ends your run!
                  </p>
                </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-lg p-6 border">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          <h4 className="font-medium mb-2">🌀 Wraparound Mechanics</h4>
                          <p className="text-sm text-gray-600">
                            Pieces can wrap around board edges, creating infinite tactical possibilities!
                          </p>
                        </div>
                        <div>
                          <h4 className="font-medium mb-2">📈 Progressive Difficulty</h4>
                          <p className="text-sm text-gray-600">
                            Each opponent gets stronger and better at using unboxed tactics.
                          </p>
                        </div>
                        <div>
                          <h4 className="font-medium mb-2">🎯 One Shot</h4>
                          <p className="text-sm text-gray-600">
                            Lose a single game and your run is over. Master the wraparound!
                          </p>
                        </div>
                        <div>
                          <h4 className="font-medium mb-2">🏆 Score System</h4>
                          <p className="text-sm text-gray-600">
                            Each win adds to your score. Can you master infinite chess?
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                      <div className="flex items-center space-x-2 text-purple-800">
                        ...
                        <span className="font-medium">Unboxed Challenge Warning</span>
                      </div>
                      <p className="text-purple-700 mt-2 text-sm">
                        Chess Unboxed endless mode is even more challenging than classic! The AI opponents 
                        will use advanced wraparound tactics. Are you ready for the ultimate unboxed test?
                      </p>
                    </div>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-6 flex items-center justify-between">
              ...
              <div className="text-center">
                <h1 className="text-2xl font-gaming font-bold text-gaming-text-primary">Chess Unboxed - Endless Mode</h1>
