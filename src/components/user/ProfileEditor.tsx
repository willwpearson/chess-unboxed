  ...
  if (!user) {
    return (
      <Card className="p-6 text-center">
        <p className="text-status-danger">No user data available</p>
      </Card>
    );
  }
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <Card className="p-6">
        ...
        {/* General Error */}
        {errors.general && (
          <div className="mb-6 p-4 bg-status-danger/10 border border-status-danger rounded-lg">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              <div className="w-24 h-24 rounded-full border-2 border-accent-primary overflow-hidden bg-surface-hover flex items-center justify-center transition-all duration-300">
                {avatarPreview ? (
                  <img
                    src={avatarPreview}
                    alt="Avatar preview"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Username */}
          <div>
            <label htmlFor="username" className="block text-sm font-semibold text-fg mb-2">
              Username *
            </label>
            <input
              id="username"
              ...
              className={cn(
                'w-full px-4 py-3 bg-surface-sunken border rounded-lg text-fg placeholder-fg-muted focus:outline-none focus:ring-2 focus:ring-accent-primary transition-colors',
                errors.username ? 'border-status-danger' : 'border-border-subtle'
              )}
          ...
          {/* Display Name */}
          <div>
            <label htmlFor="display_name" className="block text-sm font-semibold text-fg mb-2">
              Display Name *
            </label>
            <input
              id="display_name"
              ...
              className={cn(
                'w-full px-4 py-3 bg-surface-sunken border rounded-lg text-fg placeholder-fg-muted focus:outline-none focus:ring-2 focus:ring-accent-primary transition-colors',
                errors.display_name ? 'border-status-danger' : 'border-border-subtle'
              )}
          ...
          {/* Country */}
          <div>
            <label htmlFor="country" className="block text-sm font-semibold text-fg mb-2">
            ...
            <input
              ...
              className={cn(
                'w-full px-4 py-3 bg-surface-sunken border rounded-lg text-fg placeholder-fg-muted focus:outline-none focus:ring-2 focus:ring-accent-primary transition-colors',
                errors.country ? 'border-status-danger' : 'border-border-subtle'
              )}
          ...
          {/* Website */}
          <div>
            <label htmlFor="website" className="block text-sm font-semibold text-fg mb-2">
            ...
            <input
              ...
              className={cn(
                'w-full px-4 py-3 bg-surface-sunken border rounded-lg text-fg placeholder-fg-muted focus:outline-none focus:ring-2 focus:ring-accent-primary transition-colors',
                errors.website ? 'border-status-danger' : 'border-border-subtle'
              )}
        ...
        {/* Bio */}
        <div className="mt-6">
          <label htmlFor="bio" className="block text-sm font-semibold text-fg mb-2">
            Bio
          </label>
          <textarea
            id="bio"
            ...
            rows={4}
            className={cn(
              'w-full px-4 py-3 bg-surface-sunken border rounded-lg text-fg placeholder-fg-muted focus:outline-none focus:ring-2 focus:ring-accent-primary transition-colors resize-none',
              errors.bio ? 'border-status-danger' : 'border-border-subtle'
            )}
        ...
        {/* Action Buttons */}
        <div className="flex justify-end space-x-4 mt-8 pt-6 border-t border-border-subtle">
          <Button
            type="button"
            variant="outline"
